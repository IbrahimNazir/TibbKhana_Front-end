...
class CompanyEditBankComponent extends React.Component {
  ...
  async formSubmit(event) {
    ...
    console.log("company no: ",this.props.match.params.company_id)
  ...
  async fetchCompanyBankData() {
    ...
    this.setState({ bank_account_noo: companydata.data.data.bank_account_no });
                    ...
                    <div className="form-group">
                      <div className="form-line">
                        <input
                          ...
                          defaultValue={this.state.bank_account_noo}
                        />
                      </div>
                    </div>
