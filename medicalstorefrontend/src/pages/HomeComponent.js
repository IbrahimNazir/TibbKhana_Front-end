        ...
        <div className="container-fluid">
          ...
          <div className="row clearfix">
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box-3 bg-pink hover-expand-effect">
                <div className="icon">
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box-3 bg-cyan hover-expand-effect">
                <div className="icon">
                  <i className="material-icons">bookmark</i>
                </div>
                <div className="content">
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box-3 bg-light-green hover-expand-effect">
                <div className="icon">
                  <i className="material-icons">bookmark</i>
                </div>
                <div className="content">
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box-3 bg-orange hover-expand-effect">
                <div className="icon">
                  <i className="material-icons">bookmark</i>
                </div>
                <div className="content">
