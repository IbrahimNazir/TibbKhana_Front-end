...
class CompanyDetailsComponent extends React.Component {
    ...
    async formSubmit(event) {
        ...
        console.log("company no: ", this.props.match.params.id)
    ...
    //   async deleteCompanyBank(event) {
    //     // event.preventDefault();
    //     // this.setState({ btnMessage: 1 });

    //     var apiHandler = new APIHandler();
    //     // console.log(this.props.match.params.company_id)
    //     var response = await apiHandler.deleteCompanyBankData(
                                            ...
                                            {this.state.companyBank.map((company) => (
                                                <tr key={company.id}>
                                                    ...
                                                    <td>
                                                        ...
                                                        {/* <button className="btn btn-block btn-danger" onClick={() => this.deleteCompanyBank()}>
                                                            DELETE
                                                        </button> */}
                                                    </td>
                                                </tr>
